                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <button
                      ...
                      className={`flex items-center gap-2 p-3 rounded-lg border transition-all ${twoFactorMethod === 'authenticator'
                    ...
                    <button
                      ...
                      className={`flex items-center gap-2 p-3 rounded-lg border transition-all ${twoFactorMethod === 'sms'
                          ? 'border-[#0F0] bg-[#0F0]/10'
                          : 'border-gray-700 hover:border-[#0F0]/50'
                        }`}
                    >
